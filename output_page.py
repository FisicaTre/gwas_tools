...
#             "--imfs_to_plot {}".format(",".join([str(i) for i in range(1, SUMMARY_IMFS + 1)])),
#             "--omegagram_thr {:.2f}".format(OMEGAGRAM_THR)
#         ]
...
#             PLOTS_SCRIPT_NAME,
#             "--ipath {}".format(res_path),
#             "--comparison {}".format(",".join([str(i) for i in range(1, SUMMARY_IMFS + 1)]))
#         ]
